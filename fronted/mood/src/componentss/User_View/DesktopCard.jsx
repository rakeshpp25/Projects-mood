...
function DesktopCard() {
  return (
    <>
    { ["Trending Libraries", "Libraries Near You"].map((item)=>(
       <div className={styles.TrendingLibrariesNCrds}>
       <div className={styles.trendingLibrary}>
       {item}
       </div>
       ...
       <div className={styles.upperDetailsDiv}>
                 <div className={styles.libraryTitle}>
                   <span>Knowledge zone library</span>
                 </div>
